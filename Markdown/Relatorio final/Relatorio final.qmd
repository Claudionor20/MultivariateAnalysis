...
$( {(xj , \pi_i), \space j = 1, \ldots , n, \space i = 1, 2} )$, em que
...
<<<<<<< HEAD
Note que o denominador dessa equação é um escalar $1x1$, e portanto, a
...
### Mapa de Calor da variável IPS para o ano de 2022 por região administrativa
